...
# -----------------------------------------------------------------
#
# TE optimisation method unit-test that checks that the partial accept flag
# works as expected for all TE optimisation methods. The test scenario and
# topologies are outlined in Docs/TECodeUnitTest-ChecmPartialSol.md
#
# Run using the command:
#   python -m unittest code_te_partial_accept
#
# -----------------------------------------------------------------
...
class TEOptimisationTest(unittest.TestCase):
    ...
    def test_case_01(self):
        ...
        expected_gp_CSPF = {("src", "dst"): {"groups": {
            "s1": [3, 2], "s2": [2, 1], "s3": [2, 1], "s5": [4]}}}
