...
plot 'ConLoss/abi_3_0/0.dat' using 2:3 title 'CSPF' w lp ls 1 lw 4 pt 0, \
    'ConLoss/abi_3_0/1.dat' using 2:3 title 'MCF' w lp ls 2 lw 4 pt 0 dt (4,1,4,1) , \
    'ConLoss/abi_3_0/2.dat' using 2:3 title 'Helix' w lp ls 7 lw 4 pt 0 dt (6,3,2,3)
...
plot 'PathChurn/abi_3_0/0.dat' using 2:3 title 'CSPF' w lp ls 1 lw 4 pt 0, \
    'PathChurn/abi_3_0/1.dat' using 2:3 title 'MCF' w lp ls 2 lw 4 pt 0 dt (4,1,4,1), \
    'PathChurn/abi_3_0/2.dat' using 2:3 title 'Helix' w lp ls 7 lw 4 pt 0 dt (6,3,2,3)
