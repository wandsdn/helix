...
Controller Config File: MDC_Scenario_Config/c*_v3.conf
Port Description File : MDC_Scenario_Config/c*_v3.csv

Topo Diagram:
    Networks/Diagram/MultiDomainController_v3.png
"""
...
class NetTopo(TopoBase):
    ...
    def build(self):
        ...
        self.addLink(s5, s8, cls=TCLink, bw=100)
        self.addLink(s7, s9, cls=TCLink, bw=300)

        self.addLink(s2, s10, cls=TCLink, bw=1000)
