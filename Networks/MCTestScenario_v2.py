...
Controller Config File: MDC_Scenario_Config/c*_v2.conf
Port Description File : MDC_Scenario_Config/c*_v2.csv

Topo Diagram:
    Networks/Diagram/MultiDomainController_v2.png
"""
...
class NetTopo(TopoBase):
    ...
    def build(self):
        ...
        self.addLink(s2, s6, cls=TCLink, bw=1000)
